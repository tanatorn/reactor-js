...
_commander2.default.version('0.0.7').usage('<command>').option('init', 'Create a new Reactor project').option('serve', 'Run a Reactor server instance').option('build', 'Build the static website').parse(process.argv);
